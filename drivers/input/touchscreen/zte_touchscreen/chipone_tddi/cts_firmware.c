...
const struct cts_firmware *cts_request_newer_firmware_from_fs(const char *filepath, u16 curr_version)
{
...
const struct cts_firmware *cts_request_firmware(u16 hwid, u16 fwid, u16 curr_firmware_ver)
{
	...
	if (is_filesystem_mounted(CFG_CTS_FIRMWARE_FILEPATH)) {
		firmware_from_file = cts_request_newer_firmware_from_fs(CFG_CTS_FIRMWARE_FILEPATH,
									firmware_builtin ?
